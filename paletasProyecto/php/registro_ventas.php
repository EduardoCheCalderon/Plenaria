...
if (!empty($_POST["btnregistrar"])){
    if (!empty($_POST["ID_paleta"])and !empty($_POST["Cantidad"])and !empty($_POST["Fec_mov"])and !empty($_POST["Tipo_mov"])) {
        ...
        $sql=$conn->query("INSERT INTO ventas(ID_paleta,Cantidad,Fec_mov,Tipo_mov)values('$ID_paleta', '$Cantidad', '$Fec_mov', '$Tipo_mov')");
        if($sql==1) {
