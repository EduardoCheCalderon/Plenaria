...
<body>
    ...
    <form class="col-4 p-3 m-auto" method="POST">
         ...
         <div class="mb-3">
                ...
                <input type="text" class="form-control" id="ID_paleta" name="ID_paleta" placeholder="Ingrese el ID de la paleta">
         </div>
         ...
         <div class="mb-3">
             ...
             <input type="number" class="form-control" id="Tipo_mov" name="Tipo_mov" placeholder="Ingrese el tipo de movimiento">
         </div>
